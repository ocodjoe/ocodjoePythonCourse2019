...
## Could also do this to call without module name
...
me = Human(age = 26, sex = 'Male', name = "Ryden")
print(me.name)
print(me.age)
...
dir(Human)
me = Human(age = 26, name = "Ryden", sex = "Male")
me.speak('Hello')
me.introduce()
...
rare_burger = Burger("beef", "rare", 0.25, ["cheese"], "bread")
print(rare_burger.cook())
print(rare_burger.tastiness())
print(rare_burger)


well_done_burger = Burger("turkey", "well", 0.33, ["ice cream", "bacon"], "bread")
print(well_done_burger.cook())
print(well_done_burger.tastiness())
print(well_done_burger)


veggie_burger = VeggieBurger(["tomato", "bacon"], "bread")
print(veggie_burger.cook())
